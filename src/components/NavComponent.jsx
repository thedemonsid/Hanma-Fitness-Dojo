      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <NavLink href="/Dashboard" icon={<BarChart2 size={18} />}>
              Dashboard
            </NavLink>
            <NavLink href="/Gym/your-workout" icon={<Dumbbell size={18} />}>
              Gym Planner
            </NavLink>
            <NavLink href="/Diet/your-meal" icon={<Apple size={18} />}>
              Diet Planner
            </NavLink>
            {isAuthenticated ? (
      ...
      {mobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <MobileNavLink href="/Dashboard" icon={<BarChart2 size={18} />}>
              Dashboard
            </MobileNavLink>
            <MobileNavLink
            ...
            <MobileNavLink href="/Diet/your-meal" icon={<Apple size={18} />}>
              Diet Planner
            </MobileNavLink>
            {!isAuthenticated && (
              <Button
